...
class CControllerAuthenticationEdit extends CController {
	...
	protected function checkInput() {
		$fields = [
			...
			'authentication_type' =>		'in '.ZBX_AUTH_INTERNAL.','.ZBX_AUTH_LDAP.','.ZBX_AUTH_KEYCLOAK,
			...
			'keycloak_auth_enabled' =>		'in '.ZBX_AUTH_KEYCLOAK_DISABLED.','.ZBX_AUTH_KEYCLOAK_ENABLED,
			'saml_idp_entityid' =>			'db config.saml_idp_entityid',
			'saml_sso_url' =>				'db config.saml_sso_url',
			'keycloak_auth_url' =>				'db config.keycloak_auth_url',
			...
			'keycloak_realm' =>			'db config.keycloak_realm',
			'keycloak_clientid' =>			'db config.keycloak_clientid',
			'keycloak_client_secret' =>			'db config.keycloak_client_secret',
			'keycloak_client_scope' =>			'db config.keycloak_client_scope',
